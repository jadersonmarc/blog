        ...
        <b-form>
            ...
            <b-form-group label="Descrição" label-for="article-description">
                <b-form-input id="article-description" type="text"
                    v-model="article.sub_title" required
                    :readonly="mode === 'remove'"
                    placeholder="Informe o Nome do Artigo..." />
            </b-form-group>
            ...
            <b-form-group v-if="mode === 'save'" 
                ...
                <b-form-select id="article-categoryId"
                    :options="categories" v-model="article.category" />
            </b-form-group>
            <b-form-group v-if="mode === 'save'" 
                label="Autor:" label-for="article-userId">
                <b-form-select id="article-userId"
                    :options="users" v-model="article.autor" />
            </b-form-group>
            <b-form-group v-if="mode === 'save'"
    ...
    data: function() {
        return {
            ...
            fields: [
                ...
                { key: 'sub_title', label: 'Descrição', sortable: true },
